...
# Cadence réaliste : 1 envoi toutes les 2.0s à 3.0s pour chaque capteur
ACTIVE_SENSORS = [
    # ── Température (Chambres froides & Serres AzurA) ──
    {"type": "temperature", "id": "sensor_temp_001", "loc": "agadir_serre_1",          "interval": 2.0},
    {"type": "temperature", "id": "sensor_temp_002", "loc": "agadir_chambre_froide_2",  "interval": 2.0}, # Capteur avec surchauffe progressive
    {"type": "temperature", "id": "sensor_temp_003", "loc": "dakhla_station_emballage", "interval": 2.5},
    ...
    {"type": "vibration",   "id": "sensor_vib_003",  "loc": "casablanca_logistique",    "interval": 3.0},

    # ── Pression (Conduites d'eau & Réseau hydraulique) ──
    {"type": "pression",    "id": "sensor_pres_001", "loc": "agadir_reseau_principal",  "interval": 2.0},
    {"type": "pression",    "id": "sensor_pres_002", "loc": "kenitra_station_filtrage", "interval": 2.5},
    {"type": "pression",    "id": "sensor_pres_003", "loc": "dakhla_dessalement_p1",    "interval": 3.0},

    # ── Humidité (Entrepôts de stockage des récoltes) ──
    {"type": "humidite",    "id": "sensor_hum_001",  "loc": "agadir_entrepot_central",  "interval": 3.0},
    {"type": "humidite",    "id": "sensor_hum_002",  "loc": "stockage_legumes_ch1",     "interval": 3.0},
    {"type": "humidite",    "id": "sensor_hum_003",  "loc": "stockage_legumes_ch2",     "interval": 3.0},
    ...
    {"type": "consommation", "id": "sensor_pow_002",  "loc": "groupe_secours_agadir",    "interval": 2.5},
    {"type": "consommation", "id": "sensor_pow_003",  "loc": "station_solaire_dakhla",   "interval": 3.0},
]
